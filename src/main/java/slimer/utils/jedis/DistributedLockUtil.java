...
import slimer.utils.AppUtils;

public class DistributedLockUtil {

	private static SlimerJedisConnectionFactory connectionFactory = null;
	...
	private static SlimerJedisConnectionFactory getConnectionFactory() {
		if (DistributedLockUtil.connectionFactory == null) {
			synchronized (DistributedLockUtil.class) {
				if (DistributedLockUtil.connectionFactory == null) {
					DistributedLockUtil.connectionFactory = AppUtils.getBean(SlimerJedisConnectionFactory.class);
				}
			}
		}
