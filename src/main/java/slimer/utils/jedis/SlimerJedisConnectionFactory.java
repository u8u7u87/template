...
public class SlimerJedisConnectionFactory implements InitializingBean, DisposableBean, RedisConnectionFactory {
	 ...
	 */
	public SlimerJedisConnectionFactory() {
	}
	 ...
	 *            shard information
	 */
	public SlimerJedisConnectionFactory(JedisShardInfo shardInfo) {
	 ...
	 *            pool configuration
	 */
	public SlimerJedisConnectionFactory(JedisPoolConfig poolConfig) {
	 ...
	 * @since 1.4
	 */
	public SlimerJedisConnectionFactory(RedisSentinelConfiguration sentinelConfig) {
	 ...
	 * @since 1.4
	 */
	public SlimerJedisConnectionFactory(RedisSentinelConfiguration sentinelConfig, JedisPoolConfig poolConfig) {
	...
	protected Pool<Jedis> createRedisSentinelPool(RedisSentinelConfiguration config) {
		return new JedisSentinelPool(config.getMaster().getName(), convertToJedisSentinelSet(config.getSentinels()), getPoolConfig() != null ? getPoolConfig() : new JedisPoolConfig(), getTimeoutFrom(getShardInfo()), getShardInfo().getPassword());
	}
